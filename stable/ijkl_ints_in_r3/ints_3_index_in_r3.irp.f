 BEGIN_PROVIDER [double precision, big_array_coulomb_integrals_ijkl_r3, (mo_num,mo_num, mo_num)]
&BEGIN_PROVIDER [double precision, big_array_exchange_integrals_ijkl_r3,(mo_num,mo_num, mo_num)]
 implicit none
 integer :: i,j,k,l
