...
END_PROVIDER
 ...
 BEGIN_PROVIDER [ double precision, mo_bielec_integral_erf_mu_of_r_jj_from_ao, (mo_num,mo_num) ]
&BEGIN_PROVIDER [ double precision, mo_bielec_integral_erf_mu_of_r_jj_exchange_from_ao, (mo_num,mo_num) ]
&BEGIN_PROVIDER [ double precision, mo_bielec_integral_erf_mu_of_r_jj_anti_from_ao, (mo_num,mo_num) ]
  BEGIN_DOC
...
END_PROVIDER 
 ...
 BEGIN_PROVIDER [ double precision, mo_bielec_integral_erf_mu_of_r_jj, (mo_num,mo_num) ]
&BEGIN_PROVIDER [ double precision, mo_bielec_integral_erf_mu_of_r_jj_exchange, (mo_num,mo_num) ]
&BEGIN_PROVIDER [ double precision, mo_bielec_integral_erf_mu_of_r_jj_anti, (mo_num,mo_num) ]
  implicit none
  BEGIN_DOC
...
subroutine add_integrals_to_map_erf_mu_of_r(mask_ijkl)
  ...
  do l1 = 1,ao_num
    ...
    do k1 = 1,ao_num
      two_e_tmp_2 = 0.d0
      do j1 = 1,ao_num
        call get_ao_bielec_integrals_erf_mu_of_r(j1,k1,l1,ao_num,two_e_tmp_0(1,j1)) ! all integrals for a given l1, k1
