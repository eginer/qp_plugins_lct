 BEGIN_PROVIDER [double precision, big_array_coulomb_integrals_erf_mu_of_r, (mo_num,mo_num, mo_num)]
&BEGIN_PROVIDER [double precision, big_array_exchange_integrals_erf_mu_of_r,(mo_num,mo_num, mo_num)]
 implicit none
 integer :: i,j,k,l
...
!BEGIN_PROVIDER [double precision, big_array_coulomb_integrals_sr, (mo_num,mo_num, mo_num)]
!&BEGIN_PROVIDER [double precision, big_array_exchange_integrals_sr,(mo_num,mo_num, mo_num)]
!implicit none
!integer :: i,j,k,l
