...
! d_e_d_n    <- subroutine de_dn_at_r
 ...
 do k=1, mo_num
  do l=1, mo_num
   call potential_c_supbeot(k,l, vc_i_j)
...
! d_e_d_n    <- subroutine de_dn_at_r
 ...
 do j=1, mo_num
  do k=1, mo_num
   do l=1, mo_num
    do m=1, mo_num
     call potential_c_supbeot(k,l,m,n,vc_i_j, vc_i_j_n2)
     int_vc_supbeot_n2_test += delta_gamma_i_j(k,l)*vc_i_j_n2
    enddo
   enddo
  enddo
 enddo
...
subroutine potential_c_supbeot(k,l,vc_i_j, vc_i_j_n2)
 implicit none
 BEGIN_DOC
