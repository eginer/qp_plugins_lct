program test_energy_integral_lda
 ...
 double precision :: grad_dm_a(n_points_final_grid), grad_dm_b(n_points_final_grid)
 double precision :: aos_array(n_points_final_grid), grad_aos_array(n_points_final_grid)
 ...
 enddo 
   ...
   !exPBE
   call energy_x_pbe_test (dm_a, dm_b, grad_dm_a, grad_dm_b, ex_pbe_test)
   call energy_x_pbe_test (dm_a_plus_delta, dm_b_plus_delta, grad_dm_a, grad_dm_b, ex_pbe_test_plus_delta)
