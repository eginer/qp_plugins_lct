...
!            : aos_4th_cross_array(3,i) = Fourth partial derivative of the ao(i) evaluated at r by Z and X (d^4ao(i)/dx^2dz^2)
 ...
 implicit none
 BEGIN_DOC
! input      : r(1) = x, r(2) = y, r(3) = z
!
! output     : nabla_2_at_r(1,i,j) = (d/d_x)^2 (ao_i(r),ao_j(r))
!
!            : nabla_2_tot_at_r(i,j) = (d/d_x)^2 (ao_i(r),ao_j(r)) 
!        
!                                    + (d/d_y)^2 (ao_i(r),ao_j(r)) 
!        
!                                    + (d/d_z)^2 (ao_i(r),ao_j(r)) 
 END_DOC
 double precision, intent(in) :: r(3)
...
! input      : r(1) = x, r(2) = y, r(3) = z
!
! output     : nabla_4_tot_at_r(i,j) = (d/d_x)^4 (ao_i(r),ao_j(r)) 
!        
!                                    + (d/d_y)^4 (ao_i(r),ao_j(r)) 
!        
!                                    + (d/d_z)^4 (ao_i(r),ao_j(r)) 
 END_DOC
 double precision, intent(in) :: r(3)
...
! input      : r(1) = x, r(2) = y, r(3) = z
!
! output     : nabla_3_tot_at_r(i,j) = (d/d_x)^3 (ao_i(r),ao_j(r)) 
!        
!                                    + (d/d_y)^3 (ao_i(r),ao_j(r)) 
!        
!                                    + (d/d_z)^3 (ao_i(r),ao_j(r)) 
 END_DOC
 double precision, intent(in) :: r(3)
...
!
!            : blablablablablabla 
!  nabla_4_at_r_contrib(1,i,j) = (d/d_x)^2 (d/d_y)^2(ao_i(r),ao_j(r)) 
!
!  nabla_4_at_r_contrib(2,i,j) = (d/d_z)^2 (d/d_y)^2(ao_i(r),ao_j(r))
!
!  nabla_4_at_r_contrib(3,i,j) = (d/d_z)^2 (d/d_x)^2(ao_i(r),ao_j(r))
!
!  nabla_4_at_r_contrib(4,i,j) = (d/d_x)^4(ao_i(r),ao_j(r))
!
!  nabla_4_at_r_contrib(5,i,j) = (d/d_y)^4(ao_i(r),ao_j(r))
!
!  nabla_4_at_r_contrib(6,i,j) = (d/d_z)^4(ao_i(r),ao_j(r))
 END_DOC
 double precision, intent(in) :: r(3)
