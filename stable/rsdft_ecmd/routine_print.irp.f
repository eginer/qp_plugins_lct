...
!  Multiplied by 2 because of difference of normalizations between the on_top of QP2 and that of JCP, 150, 084103 1-10 (2019)
   ...
   on_top_UEG = (rho**2)*g0
  !ON-TOP-EXACT 
   call exmdsrPBEn2(mu,rho_a,rho_b,grad_rho_a_2,grad_rho_b_2,grad_rho_2,grad_rho_a_b,on_top,ex_srmuPBE)
   int_exmdsrpbe_n2_exact += ex_srmuPBE*weight

  !ON-TOP EXTRAP
   call exmdsrPBEn2(mu,rho_a,rho_b,grad_rho_a_2,grad_rho_b_2,grad_rho_2,grad_rho_a_b,on_top_extrap,ex_srmuPBE)
   int_exmdsrpbe_n2_extrapolated += ex_srmuPBE*weight

  !ON-TOP UEG
   call exmdsrPBEn2(mu,rho_a,rho_b,grad_rho_a_2,grad_rho_b_2,grad_rho_2,grad_rho_a_b,on_top_UEG,ex_srmuPBE)
