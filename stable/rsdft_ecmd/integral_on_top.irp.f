 ...
 double precision, allocatable :: integrals_ijl(:)
 allocate(integrals_ijl(mo_num))
   ...
   do i = 1, n_core_inact_act_orb
    ...
    do j = 1, n_core_inact_act_orb
     ...
     do l = 1, n_core_inact_act_orb
      ...
      call get_mo_bielec_integrals_ijkl_r3(jorb,iorb,lorb,mo_num,integrals_ijl,mo_integrals_ijkl_r3_map)
      do k = 1, n_core_inact_act_orb
       korb = list_core_inact_act(k)
       integral_on_top(istate) += full_occ_2_rdm_ab_mo(k,l,i,j,istate) * integrals_ijl(korb)
       enddo
      enddo
     enddo
    enddo
   enddo
 deallocate(integrals_ijl)
