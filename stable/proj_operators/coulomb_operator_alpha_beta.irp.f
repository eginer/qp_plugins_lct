subroutine f_PSI_ab_routine(r1,r2,coulomb,two_body_dm)
 ...
 double precision :: integral,get_two_e_integral
 threshold = 0.d0
...
BEGIN_PROVIDER [double precision, integrals_for_hf_potential, (mo_num,mo_num,elec_alpha_num,elec_alpha_num)]
 implicit none
 integer :: i,j,m,n
 double precision :: get_two_e_integral
...
BEGIN_PROVIDER [double precision, integrals_for_hf_potential_integrated_on_beta, (mo_num,elec_alpha_num)]
 implicit none
 integer :: i,j,k
 double precision :: get_two_e_integral
 integrals_for_hf_potential_integrated_on_beta = 0.d0
 do k = 1, elec_alpha_num ! electron 1 alpha 
  do i = 1, mo_num   ! electron 1 alpha
   do j = 1, elec_beta_num ! electron 2 beta 
    integrals_for_hf_potential_integrated_on_beta(i,k) += get_two_e_integral(i,j,k,j,mo_integrals_map) 
   enddo
  enddo
 enddo
END_PROVIDER 
...
! should be the average value of the alpha/beta two-electron repulsion over the HF wave function
 END_DOC
