BEGIN_PROVIDER [double precision, V_kl_contracted_r6, (n_points_final_grid,n_points_final_grid,mo_tot_num,mo_tot_num)]
 implicit none
 BEGIN_DOC
! V_kl_contracted(ipoint,k,l) = \sum_{ij} V_{ij}^{kl} phi_i(r_ipoint) phi_j(r_jpoint)
 ...
 !$OMP SHARED (mo_tot_num, n_points_final_grid, V_kl_contracted_r6, mo_integrals_map,final_grid_points,mos_in_r_array)
 allocate(integrals_array(mo_tot_num,mo_tot_num))
 !$OMP DO              
  do l = 1, mo_tot_num ! 2 
   do k = 1, mo_tot_num ! 1 
...
BEGIN_PROVIDER [double precision, rho2_kl_contracted_r6, (n_points_final_grid,n_points_final_grid,mo_tot_num,mo_tot_num)]
 implicit none
 BEGIN_DOC
! rho2_kl_contracted_r6(k,l,ipoint) = \sum_{ij} rho2_{ij}^{kl} phi_i(r_ipoint) phi_j(r_ipoint)
 ...
 !$OMP SHARED  (mo_tot_num, n_points_final_grid, rho2_kl_contracted_r6, final_grid_points,two_bod_alpha_beta_mo_physicist,mos_in_r_array )
 !$OMP DO              
 do l = 1, mo_tot_num ! 2 
  do k = 1, mo_tot_num ! 1 
   do jpoint = 1, n_points_final_grid
...
BEGIN_PROVIDER [double precision, integral_r1r2_f_psi_ab]
 ...
 !$OMP SHARED  (mo_tot_num, n_points_final_grid, rho2_kl_contracted_r6, V_kl_contracted_r6, final_weight_functions_at_final_grid_points,integral_r1r2_f_psi_ab)
 !$OMP DO              
 do l = 1, mo_tot_num ! 2 
  do k = 1, mo_tot_num ! 1
   do ipoint = 1, n_points_final_grid
...
BEGIN_PROVIDER [double precision, integral_r1r2_f_HF_aa]
 ...
 !$OMP SHARED  (mo_tot_num, n_points_final_grid, final_weight_functions_at_final_grid_points,integral_r1r2_f_HF_aa,final_grid_points)
 !$OMP DO              
 do ipoint = 1, n_points_final_grid
  weight1=final_weight_functions_at_final_grid_points(ipoint)
