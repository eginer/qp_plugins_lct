 double precision function core_inact_act_on_top_of_r_grid_mur_from_provider(ipoint,i_state)
 implicit none
 BEGIN_DOC
 ...
 do l = 1, n_core_inact_act_orb
  do k = 1, n_core_inact_act_orb
    do j = 1, n_core_inact_act_orb
     ...
     !                                                                                          1 2 1 2 
     core_inact_act_on_top_of_r_grid_mur_from_provider += core_inact_act_two_bod_alpha_beta_mo_physicist(i,j,k,l,i_state) * core_inact_act_mos_in_r_array_grid_mur(j,ipoint) * core_inact_act_mos_in_r_array_grid_mur(i,ipoint) * core_inact_act_mos_in_r_array_grid_mur(l,ipoint) * core_inact_act_mos_in_r_array_grid_mur(k,ipoint)
    enddo
   enddo
  enddo
 enddo
...
&BEGIN_PROVIDER [double precision, wall_time_core_inact_act_on_top_of_r_grid_mur ]
 ...
 do i_point = 1, n_points_print_mur
  do i_state = 1, N_states
   two_dm = core_inact_act_on_top_of_r_grid_mur(i_point,i_state) 
