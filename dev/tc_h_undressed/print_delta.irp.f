...
subroutine routine
 implicit none
 integer :: i
 double precision, allocatable :: delta_u0(:), h_u0(:), delta_mat(:,:), delta_u0_bis(:)
 allocate(delta_u0(N_det),h_u0(N_det), delta_u0_bis(N_det))
 ...
 call get_delta_no_store(psi_det,psi_coef,n_det,delta_u0_bis)
 double precision :: accu
 accu = 0.d0
 do i = 1, N_det
  print*,delta_u0(i),delta_u0_bis(i),dabs(delta_u0_bis(i) - delta_u0(i))
  accu += dabs(delta_u0_bis(i) - delta_u0(i))
 enddo
 print*,'accu = ',accu
 stop
