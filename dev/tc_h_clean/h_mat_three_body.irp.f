...
subroutine diag_htilde_mu_mat_three_body(key_i,hthree)
  use bitmasks
  BEGIN_DOC
...
subroutine single_htilde_mu_mat_three_body(key_j,key_i,hthree)
  use bitmasks
  BEGIN_DOC
...
subroutine double_htilde_mu_mat_three_body(key_j,key_i,hthree)
  use bitmasks
  BEGIN_DOC
