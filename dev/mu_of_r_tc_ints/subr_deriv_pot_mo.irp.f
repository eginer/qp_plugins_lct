  ...
  do i = 1, mo_num 
   do j = 1, mo_num 
    do k = 1, mo_num 
     do l = 1, mo_num 
      !                         2 1 2 1 
      deriv_mu_r_pot_chemist_mo(l,k,j,i) = deriv_mu_r_pot_chemist_mo(i,k,j,l)
     enddo
    enddo
   enddo
  enddo
     ...
     do k = l, l
      do i = 1, 2
       ...
       if(dabs(mo_prod_r1).lt.sq_thr)cycle
        ...
        accu(i,k,j,l) += func_non_hermit_at_r1_mo(ipoint,jpoint,i,k,j,l,cst_non_hermit) * weight1 * weight2
