...
! erf_mu_r12_inv_r12_rk(i,j,r) = \int dr' phi_i(r') phi_j(r') erf(mu(r) |r - r'|)/|r-r'|
 ...
 !$OMP SHARED (ao_num,n_points_final_grid,mu_of_r_prov,erf_mu_r12_inv_r12_rk,final_grid_points)
...
! coulomb_rk(i,j,r) = \int dr' phi_i(r') phi_j(r') 1/|r-r'|
 END_DOC
 double precision :: r(3),int_mu,delta,wall0,wall1,mu
 integer :: i,j,ipoint
 call wall_time(wall0)
 !$OMP PARALLEL                  &
 !$OMP DEFAULT (NONE)            &
