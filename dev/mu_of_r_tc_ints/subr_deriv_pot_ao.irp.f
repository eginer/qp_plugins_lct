...
subroutine test_lapl_gamm_r1
 ...
 double precision :: lapl_gamma,cst_lapl_gamma
 double precision :: thr, sq_thr,gauss_r12_mu_r1,erf_mur1
  ...
  do j = l, l
   do k = l, l
    do i = j, j
     ...
     contrib = dabs(num_int - deriv_mu_r_pot_chemist_ao(i,k,j,l) )
     accu_naive += contrib
     if(contrib .gt. 1.d-10)then
      print*,''
      print*,'i,k,j,l',i,k,j,l
      print*,contrib,num_int, deriv_mu_r_pot_chemist_ao(i,k,j,l)
     endif
