...
END_PROVIDER 
 ...
 BEGIN_PROVIDER [double precision, total_cas_on_top_density_new,(n_points_final_grid,N_states) ]
 implicit none
 BEGIN_DOC
 ...
 logical :: no_core
 print*,'providing the total_cas_on_top_density_new'
 ! for parallelization
 ...
 !$OMP SHARED(total_cas_on_top_density_new,n_points_final_grid,inact_density,core_density,one_e_act_density_beta,one_e_act_density_alpha,no_core,N_states)
 do i_point = 1, n_points_final_grid
  do istate = 1, N_states
   ...
   total_cas_on_top_density_new(i_point,istate) = pure_act_on_top_of_r + core_inact_dm * (one_e_act_density_beta(i_point,istate) + one_e_act_density_alpha(i_point,istate)) + core_inact_dm*core_inact_dm
  enddo
 enddo
 !$OMP END PARALLEL DO
 call wall_time(wall_1)
 print*,'provided the total_cas_on_top_density_new'
