double precision function int_ovlp_n2_jaswtrow2(r1,mu,istate,n_taylor)
 double precision, intent(in) :: r1(3),mu
...
double precision function int_erf_n2_jaswtrow2(r1,mu,istate,n_taylor)
 double precision, intent(in) :: r1(3),mu
 integer, intent(in) :: istate,n_taylor
 integer :: i,j,k,l
 double precision :: phi_ik
