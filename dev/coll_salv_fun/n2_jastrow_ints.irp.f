double precision function int_ovlp_n2_jaswtrow2(r1,muj,istate,n_taylor)
 double precision, intent(in) :: r1(3),muj
 ...
 call give_jastrow2_ovlp_ints_mo(muj,r1,n_taylor,mo_ints)
