...
subroutine routine_print_2
 ...
 do i = 1, ntheta
  ...
  call get_two_e_psi_at_r1r2(r1,r2,psi)
  r12 = dsqrt( (r1(1) - r2(1))**2.d0 +  (r1(2) - r2(2))**2.d0 + (r1(3) - r2(2))**2.d0 )
  write(i_unit_output,'(100(F16.10,X))')theta,r12, psi_ex_array(i),dabs(psi),dabs(psi)*full_jastrow_mu(mu,r12), dabs(psi)*full_jastrow_mu(mu,r12)/psi0_j,psi_ex_array(i)/psi0_ex
 enddo
end
