...
subroutine get_two_e_psi_at_r1r2(r1,r2,psi,coef_psi)
 implicit none
 double precision, intent(in) :: r1(3),r2(3),coef_psi(N_det,N_states)
 ...
 do istate = 1, N_states
  do i = 1, N_det
   ...
   psi(istate) += mos_array_r1(i_up) * mos_array_r2(i_down) * coef_psi(i,istate)
  enddo
 enddo
