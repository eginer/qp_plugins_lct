...
BEGIN_PROVIDER [ double precision, mo_x_v_ij_erf_rk_transp, (n_points_final_grid,3, mo_num, mo_num)]
 implicit none
 ...
 do i = 1, mo_num
  do j = 1, mo_num
   do m = 1, 3
    do ipoint = 1, n_points_final_grid
     mo_x_v_ij_erf_rk_transp(ipoint,m,j,i) = mo_x_v_ij_erf_rk(j,i,m,ipoint)
    enddo
   enddo
  enddo
 enddo
