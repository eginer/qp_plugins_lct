program plot_mu_of_r_tc
 ...
 double precision :: mu_grad_n_tmp, damped_mu_grad_n_tmp,mu_grad_n, mu_grad_n_damped
 integer :: i,nx,m
 nx = 1000
 xmax = 10.d0
 xmin = -10.d0
 ...
 mu_min = mu_erf
 dx_2 = 1.d-5
 write(33,*)'#1:r, 2:rho, 3:mu_lda, 4:mu_damped_lda, 5:mu_rsc, 6:mu_damped_rsc, 7:mu_basis, 8:mu_damped_basis, 9:mu_grad_n, 10:mu_damped_grad_n, 11:grad_mu_lda'
 do i = 1, nx
  r = 0.d0
  r(3) = x
  ...
  enddo
  call dm_dft_alpha_beta_at_r(r,rho_a_hf,rho_b_hf)
  write(33,'(100(F16.10,X))')x,rho_a_hf + rho_b_hf, mu, mu_damped,mu_rsc,mu_damped_rsc,mu_hf, mu_damped_hf, mu_grad_n_tmp,damped_mu_grad_n_tmp, dsqrt(grad_mu_sq)
  x += dx
 enddo
