...
BEGIN_PROVIDER [ double precision, d_dx_v_ij_erf_rk_tmp, (3,ao_num, ao_num,n_points_final_grid)]
 implicit none
 BEGIN_DOC
! d_dx_v_ij_erf_rk_tmp(m,j,i,R) = int dr phi_j(r)) (erf(mu(R) |r - R|) - 1)/|r - R| d/dx (phi_i(r) 
!
 ...
 do ipoint = 1, n_points_final_grid
  do i = 1, ao_num
   do j = 1, ao_num
    ...
    do m = 1, 3
     d_dx_v_ij_erf_rk_tmp(m,j,i,ipoint) = ( ints(m) - ints_coulomb(m))
    enddo
   enddo
  enddo
 enddo
...
BEGIN_PROVIDER [ double precision, d_dx_v_ij_erf_rk, (ao_num, ao_num,n_points_final_grid,3)]
 implicit none
 BEGIN_DOC
...
! with m == 1 -> d/dx , m == 2 -> d/dy , m == 3 -> d/dz
 ...
 do ipoint = 1, n_points_final_grid
  do i = 1, ao_num
   do j = 1, ao_num
    do m = 1, 3
     d_dx_v_ij_erf_rk(j,i,ipoint,m)= d_dx_v_ij_erf_rk_tmp(m,j,i,ipoint)
    enddo
   enddo
  enddo
 enddo
...
BEGIN_PROVIDER [ double precision, x_d_dx_v_ij_erf_rk_tmp, (3,ao_num, ao_num,n_points_final_grid)]
 implicit none
 BEGIN_DOC
 ...
 do ipoint = 1, n_points_final_grid
  do i = 1, ao_num
   do j = 1, ao_num
    ...
    r(2) = final_grid_points(2,ipoint)
    r(3) = final_grid_points(3,ipoint)
    call phi_j_erf_mu_r_dxyz_phi_bis(j,i,mu, r, ints)
    call phi_j_erf_mu_r_dxyz_phi_bis(j,i,1.d+9, r, ints_coulomb)
    do m = 1, 3
     x_d_dx_v_ij_erf_rk_tmp(m,j,i,ipoint) = ( ints(m) - ints_coulomb(m))
    enddo
   enddo
  enddo
 enddo
...
BEGIN_PROVIDER [ double precision, x_d_dx_v_ij_erf_rk, (ao_num, ao_num,n_points_final_grid,3)]
 implicit none
 BEGIN_DOC
...
! with m == 1 -> d/dx , m == 2 -> d/dy , m == 3 -> d/dz
 ...
 do ipoint = 1, n_points_final_grid
  do i = 1, ao_num
   do j = 1, ao_num
    do m = 1, 3
     x_d_dx_v_ij_erf_rk(j,i,ipoint,m)= x_d_dx_v_ij_erf_rk_tmp(m,j,i,ipoint)
    enddo
   enddo
  enddo
 enddo
