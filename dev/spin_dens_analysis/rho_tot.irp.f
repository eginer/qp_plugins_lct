...
!
 ...
 double precision :: z,c_k,c_j,n_i_h,accu,accu_z
...
!!$OMP END PARALLEL DO
 ...
 accu = 0.d0
 accu_z = 0.d0
 write(i_unit_integrated_rho_tot,*)"# z  integrated rho   sum integrated_rho   integrated_rho * z  sum integrated_rho * z "
 do i = 1, N_z_pts
  accu += integrated_rho_tot_all_points(i)
  accu_z += integrated_rho_tot_all_points(i) * z
  write(i_unit_integrated_rho_tot,*)z,integrated_rho_tot_all_points(i)/delta_z,accu,integrated_rho_tot_all_points(i) * z /delta_z, accu_z
  z += delta_z
 enddo
 print*,'sum of integrated_rho_tot = ',accu
