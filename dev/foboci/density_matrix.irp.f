 BEGIN_PROVIDER [ double precision, one_e_dm_mo_alpha_generators_restart, (mo_num,mo_num) ]
&BEGIN_PROVIDER [ double precision, one_e_dm_mo_beta_generators_restart, (mo_num,mo_num) ]
&BEGIN_PROVIDER [ double precision, norm_generators_restart]
   ...
   enddo
     ...
     one_e_dm_mo_alpha_generators_restart = 0.d0
     one_e_dm_mo_beta_generators_restart  = 0.d0
     !$OMP PARALLEL DEFAULT(NONE)                                         &
        ...
        !$OMP  elec_beta_num,one_e_dm_mo_alpha_generators_restart,one_e_dm_mo_beta_generators_restart,N_det_generators_restart,&
        !$OMP  mo_num,N_states, state_average_weight)
     ...
     do k=1,N_det_generators_restart
       ...
       do l=1,k-1
         ...
         call get_single_excitation(psi_det_generators_restart(1,1,k),psi_det_generators_restart(1,1,l),exc,phase,N_int)
     ...
     !$OMP END DO NOWAIT
     !$OMP CRITICAL
     one_e_dm_mo_alpha_generators_restart = one_e_dm_mo_alpha_generators_restart + tmp_a
     !$OMP END CRITICAL
     !$OMP CRITICAL
     one_e_dm_mo_beta_generators_restart  = one_e_dm_mo_beta_generators_restart  + tmp_b
     !$OMP END CRITICAL
...
BEGIN_PROVIDER [ double precision, one_e_dm_mo_generators_restart, (mo_num,mo_num) ]
 implicit none
 BEGIN_DOC
 ! One-body density matrix for the generators_restart
 END_DOC
 one_e_dm_mo_generators_restart = one_e_dm_mo_alpha_generators_restart + one_e_dm_mo_beta_generators_restart
END_PROVIDER

BEGIN_PROVIDER [ double precision, one_e_spin_density_mo_generators_restart, (mo_num,mo_num) ]
 implicit none
 BEGIN_DOC
 ! rho(alpha) - rho(beta)
 END_DOC
 one_e_spin_density_mo_generators_restart = one_e_dm_mo_alpha_generators_restart - one_e_dm_mo_beta_generators_restart
END_PROVIDER


 BEGIN_PROVIDER [ double precision, one_e_dm_mo_alpha_osoci, (mo_num,mo_num) ]
&BEGIN_PROVIDER [ double precision, one_e_dm_mo_beta_osoci, (mo_num,mo_num) ]
   implicit none
   BEGIN_DOC
...
END_PROVIDER
 ...
 BEGIN_PROVIDER [ double precision, one_e_dm_mo_alpha_1h1p, (mo_num,mo_num) ]
&BEGIN_PROVIDER [ double precision, one_e_dm_mo_beta_1h1p, (mo_num,mo_num) ]
   implicit none
   BEGIN_DOC
