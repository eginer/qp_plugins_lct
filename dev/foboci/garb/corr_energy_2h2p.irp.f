 BEGIN_PROVIDER [double precision, corr_energy_2h2p_per_orb_ab, (mo_num)]
&BEGIN_PROVIDER [double precision, corr_energy_2h2p_ab_2_orb, (mo_num,mo_num)]
&BEGIN_PROVIDER [double precision, corr_energy_2h2p_bb_2_orb, (mo_num,mo_num)]
&BEGIN_PROVIDER [double precision, corr_energy_2h2p_for_1h1p_a, (mo_num,mo_num)]
&BEGIN_PROVIDER [double precision, corr_energy_2h2p_for_1h1p_b, (mo_num,mo_num)]
&BEGIN_PROVIDER [double precision, corr_energy_2h2p_for_1h1p_double, (mo_num,mo_num)]
&BEGIN_PROVIDER [double precision, corr_energy_2h2p_per_orb_aa, (mo_num)]
&BEGIN_PROVIDER [double precision, corr_energy_2h2p_per_orb_bb, (mo_num)]
  ...
  do k = 1, n_virt_orb    ! beta
   ...
   do j = 1, n_inact_orb  ! alpha
    ...
    do l = 1, n_virt_orb  ! alpha
     ...
     key_tmp = ref_bitmask
     ispin = 2
     call do_single_excitation(key_tmp,i_hole,k_part,ispin,i_ok)
     if(i_ok .ne.1)cycle
     ispin = 1
     call do_single_excitation(key_tmp,j_hole,l_part,ispin,i_ok)
     if(i_ok .ne.1)cycle
...
END_PROVIDER 
 ...
 BEGIN_PROVIDER [double precision, corr_energy_2h1p_ab_bb_per_2_orb, (mo_num,mo_num)]
&BEGIN_PROVIDER [double precision, corr_energy_2h1p_for_1h1p_a, (mo_num,mo_num)]
&BEGIN_PROVIDER [double precision, corr_energy_2h1p_for_1h1p_b, (mo_num,mo_num)]
&BEGIN_PROVIDER [double precision, corr_energy_2h1p_for_1h1p_double, (mo_num,mo_num)]
&BEGIN_PROVIDER [double precision, corr_energy_2h1p_per_orb_ab, (mo_num)]
&BEGIN_PROVIDER [double precision, corr_energy_2h1p_per_orb_aa, (mo_num)]
&BEGIN_PROVIDER [double precision, corr_energy_2h1p_per_orb_bb, (mo_num)]
...
END_PROVIDER 
 ...
 BEGIN_PROVIDER [double precision, corr_energy_1h2p_per_orb_ab, (mo_num)]
&BEGIN_PROVIDER [double precision, corr_energy_1h2p_two_orb, (mo_num,mo_num)]
&BEGIN_PROVIDER [double precision, corr_energy_1h2p_per_orb_aa, (mo_num)]
&BEGIN_PROVIDER [double precision, corr_energy_1h2p_per_orb_bb, (mo_num)]
...
END_PROVIDER 
 ...
 BEGIN_PROVIDER [double precision, corr_energy_1h1p_spin_flip_per_orb, (mo_num)]
