...
subroutine H_apply_dressed_pert_singleexc(key_in, hole_1,particl_1,i_generator,iproc_in , delta_ij_generators_, Ndet_generators,psi_det_generators_input,E_ref )
  use omp_lib
  use bitmasks
  implicit none
  BEGIN_DOC
...
subroutine H_apply_dressed_pert(delta_ij_generators_,  Ndet_generators,psi_det_generators_input,E_ref)
  ...
  PROVIDE H_apply_buffer_allocated mo_two_e_integrals_in_map
...
!   ! Create bit masks for holes and particles
    ...
    if(.True.)then
     call H_apply_dressed_pert_singleexc(psi_det_generators_input(1,1,i_generator),    &
