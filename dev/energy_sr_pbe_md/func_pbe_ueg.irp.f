  ...
  BEGIN_PROVIDER [double precision, potential_c_alpha_mo_basis_pbe_ueg,(mo_num,mo_num,N_states)]
 &BEGIN_PROVIDER [double precision, potential_c_beta_mo_basis_pbe_ueg,(mo_num,mo_num,N_states)]
  implicit none
  integer :: istate

  do istate = 1, N_states
     call ao_to_mo(                                                   &
         potential_c_alpha_ao_basis_pbe_ueg(1,1,istate),                                 &
         size(potential_c_alpha_ao_basis_pbe_ueg,1),                                &
         potential_c_alpha_mo_basis_pbe_ueg(1,1,istate),                                 &
         size(potential_c_alpha_mo_basis_pbe_ueg,1)                                 &
         )

     call ao_to_mo(                                                   &
         potential_c_beta_ao_basis_pbe_ueg(1,1,istate),                                  &
         size(potential_c_beta_ao_basis_pbe_ueg,1),                                 &
         potential_c_beta_mo_basis_pbe_ueg(1,1,istate),                                  &
         size(potential_c_beta_mo_basis_pbe_ueg,1)                                  &
         )
  enddo
 ...
 BEGIN_PROVIDER [double precision, potential_c_alpha_ao_basis_pbe_ueg,(ao_num,ao_num,N_states)]
&BEGIN_PROVIDER [double precision, potential_c_beta_ao_basis_pbe_ueg,(ao_num,ao_num,N_states)]
   implicit none
   integer :: i,j,istate
   do istate = 1, n_states 
    do i = 1, ao_num
     do j = 1, ao_num
      ...
      potential_c_alpha_ao_basis_pbe_ueg(j,i,istate) = pot_scal_c_alpha_ao_basis_pbe_ueg(j,i,istate) + pot_grad_c_alpha_ao_basis_pbe_ueg(j,i,istate) + pot_grad_c_alpha_ao_basis_pbe_ueg(i,j,istate)
      potential_c_beta_ao_basis_pbe_ueg(j,i,istate) = pot_scal_c_beta_ao_basis_pbe_ueg(j,i,istate) + pot_grad_c_beta_ao_basis_pbe_ueg(j,i,istate) + pot_grad_c_beta_ao_basis_pbe_ueg(i,j,istate)
     enddo
    enddo
   enddo
...
! aos_vxc_alpha_pbe_w(j,i) = ao_i(r_j) * (v^x_alpha(r_j) + v^c_alpha(r_j)) * W(r_j)
 ...
 BEGIN_PROVIDER [double precision, pot_scal_c_alpha_ao_basis_pbe_ueg, (ao_num,ao_num,N_states)]
&BEGIN_PROVIDER [double precision, pot_scal_c_beta_ao_basis_pbe_ueg, (ao_num,ao_num,N_states)]
 implicit none
! intermediates to compute the sr_pbe potentials 
! 
 integer                        :: istate
   ...
   END_DOC
   pot_scal_c_alpha_ao_basis_pbe_ueg = 0.d0
   pot_scal_c_beta_ao_basis_pbe_ueg = 0.d0
   ...
   do istate = 1, N_states
     ...
     call dgemm('N','T',ao_num,ao_num,n_points_final_grid,1.d0,                   &
                 ...
                 pot_scal_c_alpha_ao_basis_pbe_ueg(1,1,istate),size(pot_scal_c_alpha_ao_basis_pbe_ueg,1))
     ! correlation beta
     call dgemm('N','T',ao_num,ao_num,n_points_final_grid,1.d0,                   &
                 aos_vc_beta_basis_pbe_ueg_w(1,1,istate),size(aos_vc_beta_basis_pbe_ueg_w,1),   &
                 aos_in_r_array,size(aos_in_r_array,1),1.d0,                      &
                 pot_scal_c_beta_ao_basis_pbe_ueg(1,1,istate),size(pot_scal_c_beta_ao_basis_pbe_ueg,1))
...
END_PROVIDER 
 ...
 BEGIN_PROVIDER [double precision, pot_grad_c_alpha_ao_basis_pbe_ueg,(ao_num,ao_num,N_states)]
&BEGIN_PROVIDER [double precision, pot_grad_c_beta_ao_basis_pbe_ueg,(ao_num,ao_num,N_states)]
   implicit none
   BEGIN_DOC
   ...
   double precision               :: wall_1,wall_2
   call wall_time(wall_1)
   pot_grad_c_alpha_ao_basis_pbe_ueg = 0.d0
   pot_grad_c_beta_ao_basis_pbe_ueg = 0.d0
   do istate = 1, N_states
       ! correlation alpha
       call dgemm('N','N',ao_num,ao_num,n_points_final_grid,1.d0,                     &
                  ...
                  pot_grad_c_alpha_ao_basis_pbe_ueg(1,1,istate),size(pot_grad_c_alpha_ao_basis_pbe_ueg,1))
       ! correlation beta
       call dgemm('N','N',ao_num,ao_num,n_points_final_grid,1.d0,                     &
                  aos_d_vc_beta_basis_pbe_ueg_w(1,1,istate),size(aos_d_vc_beta_basis_pbe_ueg_w,1),    &
                  aos_in_r_array_transp,size(aos_in_r_array_transp,1),1.d0,           &
                  pot_grad_c_beta_ao_basis_pbe_ueg(1,1,istate),size(pot_grad_c_beta_ao_basis_pbe_ueg,1))
   enddo
