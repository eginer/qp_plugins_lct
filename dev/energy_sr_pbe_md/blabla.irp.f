 ...
 BEGIN_PROVIDER[double precision, energy_x_blabla, (N_states) ]
&BEGIN_PROVIDER[double precision, energy_c_blabla, (N_states) ]
 implicit none
 BEGIN_DOC
...
! exchange/correlation energy with the short range pbe functional
 ...
 energy_x_blabla = 0.d0
 energy_c_blabla = 0.d0
 do istate = 1, N_states
  do i = 1, n_points_final_grid
   ...
   enddo
                             ...
                             ! inputs
   call my_new_fancy_functional(mu_erf_dft,rho_a,rho_b,grad_rho_a_2,grad_rho_b_2,grad_rho_a_b,                 &  ! outputs exchange
                             ex,vx_rho_a,vx_rho_b,vx_grad_rho_a_2,vx_grad_rho_b_2,vx_grad_rho_a_b, &  ! outputs correlation
                             ec,vc_rho_a,vc_rho_b,vc_grad_rho_a_2,vc_grad_rho_b_2,vc_grad_rho_a_b  )
   energy_x_blabla(istate) += ex * weight
   energy_c_blabla(istate) += ec * weight
  enddo
 enddo
...
END_PROVIDER
 ...
 subroutine   my_new_fancy_functional(mu,rho_a,rho_b,grad_rho_a_2,grad_rho_b_2,grad_rho_a_b,                 &  ! outputs exchange
                             ex,vx_rho_a,vx_rho_b,vx_grad_rho_a_2,vx_grad_rho_b_2,vx_grad_rho_a_b, &  ! outputs correlation
                             ec,vc_rho_a,vc_rho_b,vc_grad_rho_a_2,vc_grad_rho_b_2,vc_grad_rho_a_b  )
 implicit none
 BEGIN_DOC
 ...
 BEGIN_PROVIDER [double precision, potential_x_alpha_ao_blabla,(ao_num,ao_num,N_states)]
&BEGIN_PROVIDER [double precision, potential_x_beta_ao_blabla,(ao_num,ao_num,N_states)]
&BEGIN_PROVIDER [double precision, potential_c_alpha_ao_blabla,(ao_num,ao_num,N_states)]
&BEGIN_PROVIDER [double precision, potential_c_beta_ao_blabla,(ao_num,ao_num,N_states)]
   implicit none
 BEGIN_DOC
 ...
 END_DOC 
   ...
   do istate = 1, n_states 
    do i = 1, ao_num
     do j = 1, ao_num
      potential_x_alpha_ao_blabla(j,i,istate) = pot_sr_scal_x_alpha_ao_pbe(j,i,istate) + pot_sr_grad_x_alpha_ao_pbe(j,i,istate) + pot_sr_grad_x_alpha_ao_pbe(i,j,istate)
      potential_x_beta_ao_blabla(j,i,istate) = pot_sr_scal_x_beta_ao_pbe(j,i,istate) + pot_sr_grad_x_beta_ao_pbe(j,i,istate) + pot_sr_grad_x_beta_ao_pbe(i,j,istate)

      potential_c_alpha_ao_blabla(j,i,istate) = pot_sr_scal_c_alpha_ao_pbe(j,i,istate) + pot_sr_grad_c_alpha_ao_pbe(j,i,istate) + pot_sr_grad_c_alpha_ao_pbe(i,j,istate)
      potential_c_beta_ao_blabla(j,i,istate) = pot_sr_scal_c_beta_ao_pbe(j,i,istate) + pot_sr_grad_c_beta_ao_pbe(j,i,istate) + pot_sr_grad_c_beta_ao_pbe(i,j,istate)
     enddo
    enddo
   enddo
...
END_PROVIDER 
 ...
 BEGIN_PROVIDER [double precision, potential_xc_alpha_ao_blabla,(ao_num,ao_num,N_states)]
&BEGIN_PROVIDER [double precision, potential_xc_beta_ao_blabla,(ao_num,ao_num,N_states)]
   implicit none
 BEGIN_DOC
 ...
 END_DOC 
   ...
   do istate = 1, n_states 
    do i = 1, ao_num
     do j = 1, ao_num
      potential_xc_alpha_ao_blabla(j,i,istate) = pot_sr_scal_xc_alpha_ao_pbe(j,i,istate) + pot_sr_grad_xc_alpha_ao_pbe(j,i,istate) + pot_sr_grad_xc_alpha_ao_pbe(i,j,istate)
      potential_xc_beta_ao_blabla(j,i,istate)  = pot_sr_scal_xc_beta_ao_pbe(j,i,istate)  + pot_sr_grad_xc_beta_ao_pbe(j,i,istate)  + pot_sr_grad_xc_beta_ao_pbe(i,j,istate)
     enddo
    enddo
   enddo
