...
subroutine save_one_e_eff_pot_mu_of_r
 implicit none
 BEGIN_DOC 
...
! and will couple the WFT with DFT for the next regular WFT calculation
 ...
 call ezfio_set_mo_one_e_ints_mo_integrals_n_e(mo_eff_pot_mu_of_r_no_kin)
 call ezfio_set_mo_one_e_ints_mo_integrals_kinetic(mo_kinetic_integrals)

 call ezfio_set_ao_one_e_ints_ao_integrals_n_e(ao_eff_pot_mu_of_r)
...
subroutine save_eff_mu_of_r_two_e_ints_mo_into_ints_mo
 implicit none
 integer :: i,j,k,l
...
subroutine write_all_ints_mu_of_r
 implicit none
 BEGIN_DOC
 ...
 END_DOC
 call save_one_e_eff_pot_mu_of_r
 call save_eff_mu_of_r_two_e_ints_mo_into_ints_mo
end
