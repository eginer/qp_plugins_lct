program pt2_one_e_property
  ...
  !
  END_DOC
  provide one_prop_pot_b_provider one_prop_pot_a_provider
...
subroutine run
  ...
  print*,'total z_dipole  = ',(elec_z_dipole_moment(1) + variance(1))/(1.d0 + norm(1)) + nucl_z_dipole_moment
  stop
