...
! array_tmp_2 = 0.d0
 ...
 do j = 1, ao_num
  do l = 1, ao_num
   do i = 1, ao_num
    do k = 1, ao_num
     accu_tmp = dabs(ao_ten_no_lapl_pot(k,i,l,j) - array_tmp(k,i,l,j))
     accu += accu_tmp
     print*,k,i,l,j
...
! array_tmp_2 = 0.d0
 ...
 do j = 1, mo_num
  do l = 1, mo_num
   do i = 1, mo_num
    do k = 1, mo_num
     accu_tmp = dabs(mo_ten_no_lapl_pot_chemist(k,i,l,j) - array_tmp(k,i,l,j))
     accu += accu_tmp
     print*,k,i,l,j
     print*,'mo_ten_no_lapl_pot_chemist, array_tmp, accu_tmp'
     print*, mo_ten_no_lapl_pot_chemist(k,i,l,j), array_tmp(k,i,l,j), accu_tmp
    enddo
   enddo
  enddo
 enddo
