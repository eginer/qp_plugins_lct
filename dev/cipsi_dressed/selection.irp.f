...
subroutine splash_pq(mask, sp, det, i_gen, N_sel, bannedOrb, banned, mat, interesting, mat_p, mat_m)
  ...
  do i = 1, N_sel
    ...
    if (interesting(i) >= i_gen) then
        ...
        call get_d3_htc( det(1,1,i), bannedOrb, banned, mat_m, mat_p, mask, p, sp, psi_selectors_rcoef_transp(1, interesting(i)) &
                       , psi_selectors_lcoef_transp(1, interesting(i)) )
