...
all redundant correlation effects between the geminal function and the basis set are projected out of the wave function, 
and therefore the geminal function only deals with correlation effects orthonormal to the basis set. 
The resulting F12 theories, mainly based on perturbation theory and coupled cluster theory, are therefore 
extremely close to their parent theory, with additional two- and three-body terms resulting from the use of the geminal function. 
...
Based on such a simple mathematical structure, we propose a new Jastrow factor mimicking RS-DFT Hamiltonian at small $r_{12}$. 
...
MAKE THE LINK WITH WORK OF TENNO AND ALAVI
