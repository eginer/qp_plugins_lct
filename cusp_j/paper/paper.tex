...
From these figure, one can notice that: i) the right eigenvector $\phimub(\br{}_1,\br{}_2)$ converges faster than the FCI wave function with respect to the basis set, ii) that $\psimub(\br{}_1,\br{}_2)$ provides a remarkably good approximation to $\psiex(\br{}_1,\br{}_2)$ from the AVTZ basis set, iii) that for $\mu=0.3$ the wave function $\phimub(\br{}_1,\br{}_2)$ increases while getting toward $r_{12}=0$, whereas it decreases for $\mu=1.0$ just as the FCI wave function, iii) the wave function $\phimub(\br{}_1,\br{}_2)$ is always larger that the FCI one when $r_{12}\approx 0$. 

\begin{figure*}
 \label{fig:mu_0.3_dz_3}
        \includegraphics[width=0.45\linewidth]{He_mu_0_3_cusp_avdz_avtz_3.pdf}
        \includegraphics[width=0.45\linewidth]{He_mu_0_3_cusp_avqz_av5z_3.pdf}\\
        \caption{
...
\begin{figure*}
 \label{fig:mu_1.0_dz_3}
        \includegraphics[width=0.45\linewidth]{He_mu_1_0_cusp_avdz_avtz_3.pdf}
        \includegraphics[width=0.45\linewidth]{He_mu_1_0_cusp_avqz_av5z_3.pdf}\\
        \caption{
