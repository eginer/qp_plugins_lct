...
\begin{figure*}
 \label{fig_j_mu}
        \includegraphics[width=0.60\linewidth]{small_mu_j.pdf}\\
        \includegraphics[width=0.60\linewidth]{small_mu_exp_j.pdf}\\
...
\subsubsection{The explicit form of  $\tilde{H}[\mu]$ and some of its properties}
...
\begin{figure*}
 \label{fig_wee_mu}
        \includegraphics[width=0.60\linewidth]{w_ee.pdf}\\
        \includegraphics[width=0.60\linewidth]{w_ee_bis.pdf}\\
...
%\begin{equation}
% \label{eq:lim_mu_2}
% \lim_{r_{12} \rightarrow 0} \tilde{\mathcal{W}}_{ee}(r_{12}) = \frac{3 \mu}{\sqrt{\pi}} - \frac{1}{4}. 
%\end{equation}
%
...
%To illustrate the shape of 
%which does not diverge at $r_{12} = 0$
%\end{equation}
