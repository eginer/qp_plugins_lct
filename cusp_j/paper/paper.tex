...
\begin{figure*}
 \label{fig:mu_0.3_dz_3}
        \includegraphics[width=0.45\linewidth]{plots/He_mu_0_3_cusp_avdz_avtz_3.pdf}
        \includegraphics[width=0.45\linewidth]{plots/He_mu_0_3_cusp_avqz_av5z_3.pdf}\\
        \caption{
...
\begin{figure*}
 \label{fig:mu_1.0_dz_3}
        \includegraphics[width=0.45\linewidth]{plots/He_mu_1_0_cusp_avdz_avtz_3.pdf}
        \includegraphics[width=0.45\linewidth]{plots/He_mu_1_0_cusp_avqz_av5z_3.pdf}\\
        \caption{
...
ii) The fact that the wave function $\phimub(\br{}_1,\br{}_2)$ a maximum at $r_{12}=0$ for $\mu=0.3$ whereas it provides a minimum for $\mu=1.0$ or the FCI wave function can be explained by the shape of the effective potential $\tilde{\mathcal{W}}_{ee}(r_{12},\mu)$: the latter is attractive for $\mu=0.3$ when $r_{12}\approx 0$ whereas it is repulsive when $\mu = 1.0$ (see Fig \ref{fig_wee_compare} for a graphical representation). 
\begin{figure*}
