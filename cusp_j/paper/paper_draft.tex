...
\subsubsection{Computation of $\bigg( \nabla_1  u(r_{12};\mur{1})\bigg)^2$ }
therefore, according to Eq. \eqref{eq:grad_mur_1} one has 
\begin{equation}
 \begin{aligned}
 \deriv{}{x_1}{} u(r_{12};\mur{1}) =& \frac{1 - \text{erf}\big(\mu(\bri{1}) r_{12} \big)}{2 r_{12}}\big( x_1 - x_2) \\
                                   +&\frac{e^{-(\mu(\bri{1}) r_{12})^2}}{2 \sqrt{\pi} \mu(\bri{1})^2} \deriv{\mur{1}}{x_1}{}.  
...
One has to perform first 
\begin{equation}
 \begin{aligned}
  \deriv{}{x_1}{2} u(r_{12};\mur{1}) =  & \deriv{}{x_1}{}  \bigg(\frac{1 - \text{erf}\big(\mu(\bri{1}) r_{12} \big)}{2 r_{12}}\big( x_1 - x_2) \bigg) \\ 
      + & \deriv{}{x_1}{}  \bigg(\frac{e^{-(\mu(\bri{1}) r_{12})^2}}{2 \sqrt{\pi} \mu(\bri{1})^2} \deriv{\mur{1}}{x_1}{} \bigg).
 \end{aligned}
\end{equation}
Let us begin with the first term 
\begin{equation}
 \label{eq:_d_x_11}
 \begin{aligned}
 \deriv{}{x_1}{}  \bigg(\frac{1 - \text{erf}\big(\mu(\bri{1}) r_{12} \big)}{2 r_{12}}\big( x_1 - x_2) \bigg)  = 
&  \big( x_1 - x_2 \big) \deriv{}{x_1}{} \bigg(\frac{1 - \text{erf}\big(\mu(\bri{1}) r_{12} \big)}{2 r_{12}} \bigg) \\
...
\begin{equation}
 \begin{aligned}
 \deriv{}{x_1}{} \bigg(\frac{1 - \text{erf}\big(\mu(\bri{1}) r_{12} \big)}{2 r_{12}} \bigg) &= 
 \deriv{}{r_{12}}{} \frac{1 - \text{erf}\big(\mu(\bri{1}) r_{12} \big)}{2 r_{12}} \deriv{r_{12}}{x_1}{} \\  
 & + \deriv{}{\mur{1}}{}\frac{1 - \text{erf}\big(\mu(\bri{1}) r_{12} \big)}{2 r_{12}} \deriv{\mur{1}}{x_1}{}.
 \end{aligned}
\end{equation}
...
\begin{equation}
 \begin{aligned}
& \deriv{}{r_{12}}{} \frac{1 - \text{erf}\big(\mu(\bri{1}) r_{12} \big)}{2 r_{12}} \deriv{r_{12}}{x_1}{} = \\
& -\frac{(x_1 - x_2)}{\big(r_{12}\big)^2} \bigg( \frac{1 - \text{erf}\big(\mu(\bri{1}) r_{12} \big)}{2 r_{12}} + \frac{\mu(\br{}_1)}{\sqrt{\pi}} e^{-\big(\mu(\br{}_1) r_{12}\big)^2}\bigg),  
 \end{aligned}
\end{equation}
...
\begin{equation}
 \begin{aligned}
 \deriv{}{\mur{1}}{}\frac{1 - \text{erf}\big(\mu(\bri{1}) r_{12} \big)}{2 r_{12}} \deriv{\mur{1}}{x_1}{}  = \\
 - \deriv{\mur{1}}{x_1}{} \frac{e^{-\big(\mur{1} r_{12}\big)^2}}{\sqrt{\pi}},
 \end{aligned}
\end{equation}
and eventually 
\begin{equation}
 \begin{aligned}
& \deriv{}{x_1}{} \bigg(\frac{1 - \text{erf}\big(\mur{1} r_{12} \big)}{2 r_{12}} \bigg) = 
- \deriv{\mur{1}}{x_1}{} \frac{e^{-\big(\mur(1) r_{12}\big)^2}}{\sqrt{\pi}}\\
& -\frac{(x_1 - x_2)}{\big(r_{12}\big)^2} \bigg( \frac{1 - \text{erf}\big(\mu(\bri{1}) r_{12} \big)}{2 r_{12}} + \frac{\mu(\br{}_1)}{\sqrt{\pi}} e^{-\big(\mur{1} r_{12}\big)^2}\bigg)
 \end{aligned} 
\end{equation}
and therefore Eq. \eqref{eq:_d_x_11} becomes 
\begin{equation}
 \begin{aligned}
& \deriv{}{x_1}{}  \bigg(\frac{1 - \text{erf}\big(\mu(\bri{1}) r_{12} \big)}{2 r_{12}}\big( x_1 - x_2) \bigg)  = 
\frac{1 - \text{erf}\big(\mu(\bri{1}) r_{12} \big)}{2 r_{12}} \\
&- \deriv{\mur{1}}{x_1}{} \frac{(x_1 - x_2)e^{-\big(\mur{1} r_{12}\big)^2}}{\sqrt{\pi}}\\
& -\frac{(x_1 - x_2)^2}{\big(r_{12}\big)^2} \bigg( \frac{1 - \text{erf}\big(\mu(\bri{1}) r_{12} \big)}{2 r_{12}} + \frac{\mu(\br{}_1)}{\sqrt{\pi}} e^{-\big(\mur{1} r_{12}\big)^2}\bigg)
 \end{aligned}
\end{equation}
