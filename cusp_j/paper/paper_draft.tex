...
\subsection{Proposal of an ad-hoc symmetrization}
Let us assume that we only take a non symmetric form 
\begin{equation}
 \tilde{u}(\bd{r_1},\bd{r_2}) = u(r_{12};\mur{1}), 
\end{equation}
and we will see afterwards how to symmetrize the Hamiltonian.
